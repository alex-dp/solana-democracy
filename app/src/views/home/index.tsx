  ...
  return (
    <div className='w-screen min-h-screen p-4 apply-gradient'>
      ...
      <div className="flex flex-col" role='main'>
        ...
        <div className="flex flex-wrap place-content-center lg:px-32 xl:px-40">
          ...
          <ProgramCard destination="/fundraisers" title="Fundraisers" description="For public goods and services" button="Coming Soon" disabled={false} />
